...
export default defineConfig([
  ...
  // 아직 모듈로 빠져나가지 못한 코드가 모여 있는 파일. 여기에 구조 규칙을 걸면
  // 통과 불가능한 게이트가 되므로 예외로 둔다.
  //
  // 이 예외는 이 파일에만 적용된다. src/features/ 로 떼어낸 코드는 규칙을 그대로
  // 받으므로, 옮길 때 구조를 정리하게 된다. 파일이 사라지면 이 블록도 지운다.
  {
